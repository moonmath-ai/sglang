...
already-running server:
    ...
    python test/manual/fuzzy_match/measure_conditional_ttft_mla_moonlight.py <base_url> [donor_tokens]

`donor_tokens` (optional, default 150) sets the realized span size — see
`measure_conditional_ttft_mla.py`'s docstring (the DeepSeek-V2-Lite sibling)
for why this matters and where the >512-token ceiling probe comes from.
...
LOW, HIGH = 1000, 160000  # Moonlight-16B-A3B-Instruct vocab_size=163840
WARMUP_REPEATS = 3
MEASURED_REPEATS = 10
SEED = 20260726
